        ...
        public void handle(HttpExchange t) throws IOException {
            try {
                ...
                if(Main.getZalogowana() != null)
                {
                        ...
                        response +="<a href=\"http://localhost:8003/test\">Wypozycz ksiazke</a><br>";
                        response +="<a href=\"http://localhost:8003/test\">Oddaj ksiazke</a><br>";
                        response +="<a href=\"http://localhost:8003/test\">Wypisz dostepne ksiazki</a><br>";
                        response +="<a href=\"http://localhost:8003/test\">Wypisz Twoje ksiazki </a>";
                    }
                    else
                    {
