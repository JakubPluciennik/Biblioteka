...
public class MenuZalogowany extends MenuBazowe {
  ...
  public MenuZalogowany(Library biblioteka, GUI gui, JPanel mainPanel, CardLayout cards) {
    ...
    String[] menuOpcje =
          {"Wyloguj się", "Wypożycz książkę", "Oddaj książkę", "Wypisz dostępne książki",
              "Wypisz wypożyczone przez Ciebie książki"};
    String[] nazwyKart =
          {"MenuNiezalogowany", "WypożyczKsiążke", "OddajKsiążke", "WyswietlDostepne",
              "WyswietlWypozyczone"};
